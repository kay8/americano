...
<?php if ( have_comments() ) : ?>
	...
	<h2 id="comments" class="comment-head"><?php comments_number(__('No Responses','html5reset'), __('One Response','html5reset'), __('% Responses','html5reset') );?></h2>
...
<div id="respond" class="respond-wrapper">
